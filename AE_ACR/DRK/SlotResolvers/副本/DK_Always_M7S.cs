...
namespace AE_ACR.DRK.SlotResolvers.副本;

public class DK_Always_M7S : DRKBaseSlotResolvers
{
    public override int Check()
    {
        ...
        if (DKSettings.Instance.M7S设置 && Core.Resolve<MemApiZoneInfo>().GetCurrTerrId() == 地区ID.m7s)
        {
            if (CanWeave())
            {
                if (沉默.ActionReady2())
