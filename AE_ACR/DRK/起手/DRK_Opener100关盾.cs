...
public class DRK_Opener100关盾 : IOpener
{
    ...
    public void InitCountDown(CountDownHandler countDownHandler)
    {
        ...
        {
            countDownHandler.AddAction(10_000, DRKBaseSlotResolvers.解除深恶痛绝);
        }
        
        
        countDownHandler.AddAction(2000, DRKBaseSlotResolvers.至黑之夜, SpellTargetType.Pm2);
